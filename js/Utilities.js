...
function determineWinner({player, enemy, timerId,rectangle1,rectangle2}){
    ...
    if(player.health===enemy.health){
        ...
        document.querySelector('#displayText').style.display='flex'
        document.querySelector('#speechbubble3').innerHTML='Player 2 rests peacefully as he knows he fought honourably and has made the great Master Choshi proud. Master Choshi goes on to mark Eduv4831702\'s assignment without penalization in honour of player 2\'s noble sacrifice.'
        ...
        document.querySelector('#displayText').style.display='flex'
        document.querySelector('#speechbubble3').innerHTML='Player 1 rests peacefully as he knows he fought honourably and has made the great Master Choshi proud. Master Choshi honours the agreement that was made between his two noble disciples and goes on to mark Eduv4831702\'s assignment without penalization.'
        document.querySelector('#speechbubble3').style.display='flex'
